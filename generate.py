...
parser.add_argument("--ds_name", type=str, default="default",
...
if args.is_cmplx:
    ...
    size = 64
image_generator = ImageGenerator(size=size,batch_size=args.gen_img_batch, latent_dim= args.latent_dim,is_complex_image=args.is_cmplx)
image_generator.prepare_dataset(args.ds_name)
