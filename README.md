Application Setup
	...
	Training the Model
		...
		Start training the model:
			...
			python train.py --img_size 64 --ds_folder_name animefacedataset --latent_dim 128 --dis_lr 0.0001 --gen_lr 0.0003 --epochs 20 --batch_size 512

	Generating Images

		Run the generation script:
			
			python generate.py --img_size 64 --img_name sample_1 --latent_dim 128 --ds_name animefacedataset --gen_img_batch 256 
...
Be aware that the latent_used for training should be the same when generating as the autoencoder is set with that specific latent_dim
